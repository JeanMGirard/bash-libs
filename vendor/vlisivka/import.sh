...
[ "${__IMPORT__DEFINED:-}" == "yes" ] || {
  ...
  __IMPORT__BASE_PATH=( "${__BASH_MODULES_PATH_ARRAY[@]:+${__BASH_MODULES_PATH_ARRAY[@]}}" "${__IMPORT__BASE_PATH[@]:+${__IMPORT__BASE_PATH[@]}}" "/home/jeanmgirard/.wsl/projects/JeanMGirard/packages/bash-utils/vendor/vlisivka" )
